...
import { ensureManagedUv, managedUvPath, managedUvxPath, readRuntimeManifest, runtimePlatformKey } from "../local-agent-bridge/runtime-manager.mjs";
...
try {
  ...
  process.stdout.write(`prepared ${platformKey} · uv ${prepared.version}\n`);
} finally {
